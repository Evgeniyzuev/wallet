...
const roadmapTranslations = {
  ru: {
    ...
    //   },
      {
        name: 'Вводные задания',
        date: '2025',
        description: 'Выбрать желаемые цели для достижения с помощью ИИ-ассистента.<br/>В ядре рассчитать финансовую цель и срок.<br/>'+
        'Пригласить реферала.<br/>Доска желаний.<br/>Проверка что пользователь человек.<br/>Проверка ввода и вывода средств.  '
      },
      {
